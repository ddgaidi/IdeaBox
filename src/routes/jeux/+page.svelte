<script>
    ...
    import Jeux from '../../lib/components/jeux/Jeux.svelte';
...
<svelte:head>
    ...
    <meta property="og:title" content="ItisGame - Jeux" />
    ...
    <meta name="twitter:title" content="ItisGame - Jeux" />
